...
export  async  function mk( Images, ix)  {sys.$params(arguments.length, 2);
  const imV =sys.$checkNull( [Images[ix]]);
  ...
  const updateImageV =sys.$checkNull( [[]]);
  ...
  updateImageV[0] =sys.$checkExists(updateImageV[0], async  function( im)  {sys.$params(arguments.length, 1);
    imV[0] =sys.$checkExists(imV[0],sys.$checkNull( im));
    Images[ix] =sys.$checkExists(Images[ix],sys.$checkNull( im));
