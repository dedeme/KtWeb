...
export  function setId(a, annId)  {sys.$params(arguments.length, 2); a[id] =sys.$checkExists(a[id], annId);};



export  function update(oldA, newA)  {sys.$params(arguments.length, 2); for (const [i, v]  of sys.$forObject2( newA)) oldA[i] =sys.$checkExists(oldA[i], v);};
